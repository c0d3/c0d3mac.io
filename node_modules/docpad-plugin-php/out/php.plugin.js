...
module.exports = function(BasePlugin) {
  ...
  return PhpPlugin = (function(_super) {
    ...
    PhpPlugin.prototype.render = function(opts, next) {
      var content, data, errors, exec, file, inExtension, php, result, source, spawn, templateData, _ref;
      inExtension = opts.inExtension, templateData = opts.templateData, content = opts.content, file = opts.file;
