...
module.exports = function(BasePlugin) {
  ...
  return StylusPlugin = (function(_super) {
    ...
    StylusPlugin.prototype.render = function(opts, next) {
      var config, content, file, inExtension, library, option, outExtension, style, stylus, value, _ref1, _ref2;
      ...
      if ((inExtension === 'styl' || inExtension === 'stylus') && (outExtension === 'css' || outExtension === null)) {
        ...
        _ref1 = config.stylusOptions;
        for (option in _ref1) {
          if (!__hasProp.call(_ref1, option)) continue;
          value = _ref1[option];
          style.set(option, value);
        }
        _ref2 = config.stylusLibraries;
        for (library in _ref2) {
          if (!__hasProp.call(_ref2, library)) continue;
          value = _ref2[library];
          if (!value) {
            continue;
          }
